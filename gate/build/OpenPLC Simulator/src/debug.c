...
char plc_program_md5[] = "8dc57ef3ce27a4cb830abd6f84c3f9bf";
...
static const struct {
    ...
    {&(RES0__INSTANCE0.M_READY), BOOL_ENUM},
    {&(RES0__INSTANCE0.M_REQUEST), BOOL_ENUM},
    {&(RES0__INSTANCE0.M_PASS_ALLOWED), BOOL_ENUM},
    {&(RES0__INSTANCE0.M_EMERGENCY), BOOL_ENUM},
    {&(RES0__INSTANCE0.STA), BOOL_ENUM},
    {&(RES0__INSTANCE0.Q_READY), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.Q_REQUEST), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.Q_PASS_ALLOWED), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.Q_EMERGENCY), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CMD_ROBOT_REQUEST), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CMD_HMI_ALLOW), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CMD_ROBOT_PASSED), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CMD_EMERGENCY), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.CMD_RESET), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_READY), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_REQUEST), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_PASS_ALLOWED), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_EMERGENCY), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_BARRIER_OPEN), BOOL_O_ENUM},
    {&(RES0__INSTANCE0.STATUS_PASS_PERMISSION), BOOL_O_ENUM},
};
