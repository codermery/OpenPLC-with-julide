...
static const struct {
    ...
    {&(RES0__INSTANCE0.STATUS_BARRIER_OPEN), BOOL_ENUM},
    {&(RES0__INSTANCE0.STATUS_PASS_PERMISSION), BOOL_ENUM},
    ...
    {&(RES0__INSTANCE0.SERVO_CHANNEL), SINT_ENUM},
    {&(RES0__INSTANCE0.SERVO_FREQ), REAL_ENUM},
    {&(RES0__INSTANCE0.SERVO_DUTY_CLOSED), REAL_ENUM},
